...
using SuperBorgio.GestorWeb.Models;
...
namespace SuperBorgio.GestorWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            const string nome = "Borgio@vegasoft.com.br";
            const string senha = "Vega@2015";
            ...
            var usuario = new ApplicationUser() { UserName = nome };

            var adm = userManager.Create(usuario, senha);

            if (adm.Succeeded)
            {
                var papel = userManager.AddToRole(usuario.Id, admin);
            }
        }
